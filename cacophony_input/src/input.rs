use crate::{InputEvent, MidiConn, MidiDeltaEvent, NoteOn, QwertyBinding, KEYS};
...
pub struct Input {
    ...
    pub midi_events: HashMap<InputEvent, MidiDeltaEvent>,
    /// Input events generated by qwerty input.
    pub qwerty_events: HashMap<InputEvent, QwertyBinding>,
